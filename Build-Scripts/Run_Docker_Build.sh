...
coverage run --rcfile=../.coveragerc -m tornado.test.runtests unit_tests.run_tests && COVERALLS_REPO_TOKEN=$COVERALLS_REPO_TOKEN TRAVIS_BRANCH=$TRAVIS_BRANCH BRANCH=$TRAVIS_BRANCH coveralls
