...
RUN cd /application/MeteorJS-Application/.demeteorized/bundle/programs/server && ["/bin/bash", "-c", "source /root/.bashrc"] && nvm install 0.10.40 && nvm use 0.10.40 && npm install
#===========================Create the application in meteorJS folder==========
