...
RUN cd /application/MeteorJS-Application/.demeteorized/bundle/programs/server && chmod 775 /root/.nvm/nvm.sh && . /root/.nvm/nvm.sh && nvm install 0.10.40 && nvm use 0.10.40 && npm install
#===========================Create the application in meteorJS folder==========
