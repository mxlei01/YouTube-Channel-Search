...
RUN cd /application/MeteorJS-Application/.demeteorized/bundle/programs/server && rm /bin/sh && ln -s /bin/bash /bin/sh && source ~/.nvm/nvm.sh && nvm install 0.10.40 && nvm use 0.10.40 && npm install
#===========================Create the application in meteorJS folder==========
